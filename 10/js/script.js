        ...
        on: {
          slideChange: () => {
            if (storySlider.activeIndex === 0 || storySlider.activeIndex === 1) {
              sliderContainer.style.backgroundImage = `url("img/slide1.jpg"), linear-gradient(180deg, rgba(83, 65, 118, 0) 0%, #523E75 16.85%)`;
              document.body.classList.add(`activeslide1`);
              ...
              document.body.classList.add(`activeslide2`);
              ...
              document.body.classList.add(`activeslide3`);
            } else if (storySlider.activeIndex === 6 || storySlider.activeIndex === 7) {
              sliderContainer.style.backgroundImage = `url("img/slide4.jpg"), linear-gradient(180deg, rgba(45, 39, 63, 0) 0%, #2F2A42 16.85%)`;
              // document.body.classList.add(`activeslide4`);
            }
          },
          resize: () => {
            storySlider.update();
        ...
        on: {
          slideChange: () => {
            if (storySlider.activeIndex === 0) {
              ...
              document.body.classList.remove(`activeslide2`, `activeslide3`, `activeslide4`);
              document.body.classList.add(`activeslide1`);
            } else if (storySlider.activeIndex === 2) {
              sliderContainer.style.backgroundImage = `url("img/slide2.jpg")`;
              document.body.classList.remove(`activeslide1`, `activeslide3`, `activeslide4`);
              document.body.classList.add(`activeslide2`);
            } else if (storySlider.activeIndex === 4) {
              sliderContainer.style.backgroundImage = `url("img/slide3.jpg")`;
              document.body.classList.remove(`activeslide1`, `activeslide2`, `activeslide4`);
              document.body.classList.add(`activeslide3`);
            } else if (storySlider.activeIndex === 6) {
              sliderContainer.style.backgroundImage = `url("img/slide4.jpg")`;
              document.body.classList.remove(`activeslide1`, `activeslide2`, `activeslide3`);
              document.body.classList.add(`activeslide4`);
            }
          },
          resize: () => {
